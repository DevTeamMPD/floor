...
หลัง deploy มี one-time backfill แบบ bounded สำหรับงาน active และงานที่อัปเดต/ปิดใน 30 วันล่าสุด เพื่อสร้างเอกสารของเหตุการณ์เดิมโดยไม่ดึงประวัติทั้งระบบเข้าคิวพร้อมกัน
