...
export default function OperationsPage() {
  ...
  const [loading, setLoading] = useState(true); const [tab, setTab] = useState<"decision" | "returned" | "active">("decision"); const [canAct, setCanAct] = useState(false); const [expandedJobNo, setExpandedJobNo] = useState<string | null>(null);
